...
def clusterData(listInfo):
    ...
    clustering = DBSCAN(eps=dist/6371.0, min_samples=minSamp, algorithm='ball_tree',metric='haversine',n_jobs=10).fit(np.radians(X)) # replace the 0.005 to 0.025 for distance of 25 m
